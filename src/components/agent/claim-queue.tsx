        ...
        >
          <summary className="cursor-pointer list-none px-5 py-4 transition hover:bg-zinc-50 focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-blue-600 [&::-webkit-details-marker]:hidden">
            <div className="grid items-center gap-3 lg:grid-cols-[130px_minmax(180px,1fr)_180px_120px_130px_92px] lg:gap-4">
              <div>
                <p className="font-mono text-mini font-medium text-zinc-800">
                  {claim.caseId}
                </p>
                <p className="mt-1 font-mono text-micro text-zinc-400">
                  {claim.submittedAt}
                </p>
              </div>
              <div className="min-w-0">
                <p className="truncate text-body font-medium text-zinc-900">
                  {claim.claimantName}
                </p>
                <p className="mt-0.5 truncate text-mini text-zinc-500">
                  {claim.retailerName} · {claim.claimantEmail}
                </p>
              </div>
              <div className="min-w-0">
                <p className="truncate font-mono text-micro text-blue-700">
                  {claim.diagnosisCode}
                </p>
                <p className="mt-1 font-mono text-micro text-zinc-400">
              ...
              <p className="font-mono text-detail tabular-nums text-zinc-700">
              ...
              <span className="flex items-center justify-end gap-2 text-mini font-medium text-zinc-500 group-open:text-blue-700">
                ...
                <span
                  aria-hidden="true"
                  className="font-mono text-lead leading-none transition group-open:rotate-45"
                >
                  +
                </span>
              </span>
            ...
            <div className="grid gap-5 xl:grid-cols-[minmax(0,340px)_minmax(0,1fr)]">
              <div>
                <div className="border-l-2 border-blue-500 pl-4">
                  <p className="font-mono text-micro uppercase tracking-[0.15em] text-blue-700">
                    Pre-diagnosed
                  </p>
                  <p className="mt-2 text-body leading-6 text-zinc-700">
                ...
                {claim.clarification ? (
                  <dl className="mt-4 grid gap-3 rounded-lg border border-amber-200 bg-amber-50/60 p-4">
                    <div>
                      ...
                      <dd className="mt-1 text-detail leading-5 text-zinc-700">
                    ...
                    <div>
                      ...
                      <dd className="mt-1 font-mono text-detail leading-5 text-zinc-700">
